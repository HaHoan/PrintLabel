using PrintLabel.App.Trailer.Controls;
using System;
...
namespace PrintLabel.App.Trailer
{
    public partial class FormMain : Form
    {
        ...
        private void btn6ThA3sOEMMain_Click(object sender, EventArgs e)
        {
            AddTabPage(new us6THA3SOEMMain(), "OEM");
        }


        private void btn6ThA3SOEM_Click(object sender, EventArgs e)
        {
